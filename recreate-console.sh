...
oc create route edge  --service service/webconsole --hostname=gswmon.southcentralus.cloudapp.azure.com --path=/console --port=443  --cert=/etc/origin/master/ca.crt --key=/etc/origin/master/ca.key --ca-cert=/etc/origin/master/ca.crt 
